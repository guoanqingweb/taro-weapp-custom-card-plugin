...
let { windowHeight, windowWidth, cardWidth, cardHeight, isIphoneX } = style;
...
const thumbWidth = windowWidth / 4;
...
export default class Home extends Component {
  ...
  getCacheImgPath() {
    let cardTemPath = Taro.getStorageSync(IMGPATH_CACHE_KEY_ENTRY)
    if (!cardTemPath) {
      Taro.navigateTo({
  ...
  refreshSwiperDom() {
    ...
    setTimeout(() => this.setState({ renderSwiper: true }), 50)
  }
  ...
  handleTextElInput = e => {
    ...
    this.setState({ elInputText: value })
  }
  ...
  async canvasDrawImg() {
    ...
    let cardCoverPath = await this.getImageInfo(this.cardCoverImg)
    if(!cardCoverPath) return
