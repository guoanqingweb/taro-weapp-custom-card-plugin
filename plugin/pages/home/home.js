...
var windowHeight = _index3.style.windowHeight,
    ...
    cardWidth = _index3.style.cardWidth,
...
// const wxImg = 'https://wx.21cake.com/upload/images/97f050b824945b92c57e46d497dc02f8.jpg'

var thumbWidth = windowWidth / 4;
...
var Home = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Home() {
    ...
    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref = Home.__proto__ || Object.getPrototypeOf(Home)).call.apply(_ref, [this].concat(args))), _this2), _this2.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "anonymousState__temp8", "anonymousState__temp9", "anonymousState__temp16", "anonymousState__temp19", "loopArray28", "loopArray29", "loopArray30", "loopArray31", "loopArray32", "cardCoverImg", "cardEls", "editElIndex", "editElRotate", "thumbActiveIndex", "$anonymousCallee__20", "$anonymousCallee__21", "testImg", "showTextElArea", "showTextElInput", "elInputText", "$anonymousCallee__22", "textSwiperCurrent", "$anonymousCallee__23", "validLength", "canAddEl", "renderSwiper"], _this2.config = {
      disableScroll: true
    }, _this2.moveEl = function (left, top) {
      ...
      var value = e.detail.value;
      _this2.setState({ elInputText: value });
  ...
  _createClass(Home, [{
    ...
    value: function getCacheImgPath() {
      var cardTemPath = _index2.default.getStorageSync(_index4.IMGPATH_CACHE_KEY_ENTRY);
      if (!cardTemPath) {
        _index2.default.navigateTo({
          url: _index4.IMGPATH_CACHE_KEY_ENTRY
        });
      } else {
        this.cardCoverImg = cardTemPath;
      }
    }
  }, {
    key: "changeElStyle",
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _this, cardEls, ctx, cardCoverPath, i, _cardEls$i, isTextType, imgUrl, text, left, top, width, height, scale, rotate, color, fontSize, tran_x, tran_y, path;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 11:
                ctx.drawImage(cardCoverPath, 0, 0, cardWidth, cardHeight);
                i = 0;
              ...
              case 35:
                ctx.drawImage(path, -tran_x, -tran_y, width, height);
        ...
        return _index2.default.canvasToTempFilePath({
          ...
          success: function success(res) {
            _index2.default.setStorage({
              key: _index4.IMGPATH_CACHE_KEY_HOME,
    ...
    value: function _createData() {
      ...
      var cardCoverImg = this.cardCoverImg;
      ...
      var $anonymousCallee__20 = Array(10).fill('');
      var $anonymousCallee__21 = Array(9).fill('');
      var $anonymousCallee__22 = showTextElArea ? Array(20).fill('') : [];
      var $anonymousCallee__23 = this.__state.renderSwiper ? this.getThumbTextEls() : [];
      var loopArray28 = cardEls.map(function (item, zIndex) {
        item = {
        ...
        var _$indexKey = "djzzz" + zIndex;

        _this6.anonymousFunc1Map[_$indexKey] = function () {
          return _this6.handleThumElsClick(idx);
        };

        var _genCompid = (0, _index.genCompid)(__prefix + "eezzzzzzzz" + zIndex, true),
      ...
      var loopArray29 = Array(10).fill('').map(function (item, idx) {
        item = {
          $original: (0, _index.internal_get_original)(item)
        };

        var _$indexKey2 = "eazzz" + idx;
      ...
      var loopArray30 = Array(9).fill('').map(function (item, idx) {
        item = {
          $original: (0, _index.internal_get_original)(item)
        };

        var _$indexKey3 = "ebzzz" + idx;
      ...
      var loopArray31 = showTextElArea ? Array(20).fill('').map(function (item, idx) {
        item = {
          $original: (0, _index.internal_get_original)(item)
        };

        var _$indexKey4 = "eczzz" + idx;
      ...
      var loopArray32 = this.__state.renderSwiper ? this.getThumbTextEls().map(function (item, idx) {
        item = {
          $original: (0, _index.internal_get_original)(item)
        };
  ...
  return Home;
}(_index.Component), _class.$$events = ["anonymousFunc0", "rotateEl", "anonymousFunc2", "anonymousFunc3", "handleTextElInput", "handleTextInputBlur", "handleAddTextEl", "anonymousFunc4", "changeTextSwiper", "anonymousFunc5", "canvasDrawImg"], _class.multipleSlots = true, _class.$$componentPath = "plugin/pages/home/home", _temp2);
